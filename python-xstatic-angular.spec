...
Version:        XXX
Release:        1%{?dist}
Summary:        Angular JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-angular/
...
%{python_sitelib}/xstatic/pkg/angular
